...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sell_products', function (Blueprint $table) {
            $table->id();
            $table->foreignId('product_id')->constrained('products')->cascadeOnUpdate()->nullable();
            $table->foreignId('sells_id')->constrained('sells')->cascadeOnUpdate()->nullable();
            ...
            $table->foreignId('atm_id')->constrained('atms')->cascadeOnUpdate()->nullable();
